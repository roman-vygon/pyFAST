...
@function
def sr_interpolate(img_h_sr=None,x=None,y=None,w=None,h=None,mv_x=None,mv_y=None,*args,**kwargs):
    varargin = sr_interpolate.varargin
    nargin = sr_interpolate.nargin
...
@function
def get_reference_patch_sr(input_image=None,r=None,c=None,w=None,h=None,*args,**kwargs):
    varargin = get_reference_patch_sr.varargin
    nargin = get_reference_patch_sr.nargin
...
@function
def fractional_interpolate_sr(refer_patch=None,mv_x_ind=None,mv_y_ind=None,*args,**kwargs):
    varargin = fractional_interpolate_sr.varargin
    nargin = fractional_interpolate_sr.nargin
