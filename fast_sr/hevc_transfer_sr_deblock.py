...
@function
def hevc_transfer_sr_deblock(sr_results=None,hevc_info=None,params=None,*args,**kwargs):
    varargin = hevc_transfer_sr_deblock.varargin
    nargin = hevc_transfer_sr_deblock.nargin
...
# hevc_transfer_sr_deblock.m:139
            if b_debug == 1:
                imwrite(uint8(img_before_deblock),fullfile(cd,'..','temp_data',sprintf('deblock_input_%d.bmp',f_idx)),'BMP')
