...
def vertical_edge_deblock(img=None, QP=None):
    block_size = 8
...
def strong_filter(p_vec=None, tc=None):
    c = dot(2, tc)
...
def normal_filter_p0q0p1q1(p_vec=None, tc=None):
...
def normal_filter_p0q0(p_vec=None, tc=None):
    d0 = floor((dot(9, (p_vec(5) - p_vec(4))) - dot(3, (p_vec(6) - p_vec(3))) + 8) / 16)
...
def get_beta_tc_from_QP(QP=None):
