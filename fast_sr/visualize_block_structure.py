...
@function
def visualize_block_structure(img=None,block_struct=None,plot_color=None,*args,**kwargs):
    varargin = visualize_block_structure.varargin
    nargin = visualize_block_structure.nargin
