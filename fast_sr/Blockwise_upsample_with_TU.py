...
@function
def Blockwise_upsample_with_TU(res_l=None,TU=None,*args,**kwargs):
    varargin = Blockwise_upsample_with_TU.varargin
    nargin = Blockwise_upsample_with_TU.nargin
...
# Blockwise_upsample_with_TU.m:15
        res_h[arange((y_h + 1),(y_h + dot(2,w))),arange((x_h + 1),(x_h + dot(2,w)))]=imresize(res_l(arange((y_l + 1),(y_l + w)),arange((x_l + 1),(x_l + w))),2,'bicubic')
