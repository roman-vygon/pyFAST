...
@function
def visual_compare_two_results(m1_result=None,m2_result=None,ground_truth=None,params=None,*args,**kwargs):
    varargin = visual_compare_two_results.varargin
    nargin = visual_compare_two_results.nargin
...
# visual_compare_two_results.m:91
            all_patches[r,c]=imresize(all_patches[r,c],concat([params.large_block_size,params.large_block_size]),params.interp_method)
