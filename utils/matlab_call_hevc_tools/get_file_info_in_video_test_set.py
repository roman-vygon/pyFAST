...
@function
def get_file_info_in_video_test_set(test_dir=None,seq_name=None,*args,**kwargs):
    varargin = get_file_info_in_video_test_set.varargin
    nargin = get_file_info_in_video_test_set.nargin
