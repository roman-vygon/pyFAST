...
@function
def encode_sequence(seq_name=None,enc_params=None,*args,**kwargs):
    varargin = encode_sequence.varargin
    nargin = encode_sequence.nargin
...
# encode_sequence.m:38
    ...
    enc_info=struct('yuv_recon_name',cellarray([yuv_recon_name]),'binary_name',cellarray([binary_name]),'img_width',cellarray([img_width]),'img_height',cellarray([img_height]),'dst_dir',cellarray([yuv_recon_dir]),'seq_alias',cellarray([enc_alias]))
