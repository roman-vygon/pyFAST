...
def get_recon_inter(PU_all=None, prefilt_Y=None):
...
def get_referenced_patch(input_image=None, r=None, c=None, w=None, h=None):
    r0 = r - 3
...
def fractional_interpolate(refer_patch=None, mv_x_ind=None, mv_y_ind=None):
    filter_coeff = concat(
