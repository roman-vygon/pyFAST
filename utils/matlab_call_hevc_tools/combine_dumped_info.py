...
from libsmop import *
# combine_dumped_info.m

    
@function
def combine_dumped_info(intra_recon=None,inter_mc=None,res_all=None,inter_mask=None,*args,**kwargs):
    varargin = combine_dumped_info.varargin
    nargin = combine_dumped_info.nargin
...
# combine_dumped_info.m:13
        recon_frame[logical_not(intra_mask_frame)]=inter_mc[f_idx](logical_not(intra_mask_frame)) + res_all[f_idx](logical_not(intra_mask_frame))
